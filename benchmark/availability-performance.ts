...
const result = largeScheduler.findAvailableSlots(new Date('2024-01-15T13:00:00Z'), new Date('2024-01-19T22:00:00Z'), {
	slotDuration: 30,
	maxOverlaps: 2,
})
...
const multiDayTime = benchmark(
	'Week-long scheduling',
	() => {
...
const complexTime = benchmark(
	...
	() => {
		return complexScheduler.findAvailableSlots(new Date('2024-01-15T08:00:00Z'), new Date('2024-01-21T23:00:00Z'), {
			slotDuration: 45,
			maxOverlaps: 2,
		})
	},
