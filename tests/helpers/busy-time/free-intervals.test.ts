...
import { findFreeIntervals, busyTimesToIntervals, intervalsToTimeSlots, findAvailableSlotsWithOverlaps, type Interval } from '../../../src/helpers/busy-time/free-intervals'
...
describe('Free Intervals with K Overlaps', () => {
	describe('findFreeIntervals', () => {
		...
		test('should handle touching intervals correctly', () => {
			const busy: Interval[] = [{ start: 1, end: 3 }, { start: 3, end: 5 }]
		...
		test('should respect K overlaps threshold', () => {
			...
			const busy: Interval[] = [{ start: 1, end: 4 }, { start: 2, end: 5 }]
